...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    /* 
        handle submit takes care of validation.
    */
    return (
        <>
                ...
                <FormField 
                    ...
                    render={() => (
                        <FormItem>
                            ...
                            <FormControl>
                                <div className="0.5 border border-dashed border-neutral-400 relative h-[84px] w-[153px] group">
                                    <Image
            ...
            <div className="flex flex-col gap-y-8 lg:col-span-2">
                <div className="flex flex-col gap-4 bg-[#F9F9F9] rounded-xl overflow-hidden h-fit">
                    ...
                    <div className="p-4 flex-col gap-y-6">
                        <div className="flex justiffy-between items-center gap-x-2">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col gap-y-1">
                            ...
                            <p className="text-sm">
                                {snakeCaseToTitle(video.muxTrackStatus || "no_subtitiles") }
                            </p>
                        </div>
                    </div>
                </div>
...
/*
    Getting this one video using video Id, 
    using trpc from client 
*/