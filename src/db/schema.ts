...
export const videoReactionsSelectSchema = createSelectSchema(videoViews);
export const videoReactionsInsertSchema = createInsertSchema(videoViews);
export const videoReactionsUpdateSchema = createUpdateSchema(videoViews); 